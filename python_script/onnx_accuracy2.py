...
def get_numpy_from_img(file):
    ...
    x[0,0,:,:] -= 0.485 *255  # 123.68
    x[0,1,:,:] -= 0.456 *255  # 116.28
    x[0,2,:,:] -= 0.406 *255  # 103.53
    x[0,0,:,:] /= 0.229 *255  # /58.395  
    x[0,1,:,:] /= 0.224 *255  # /57.12   
    x[0,2,:,:] /= 0.225 *255  # /57.375  
